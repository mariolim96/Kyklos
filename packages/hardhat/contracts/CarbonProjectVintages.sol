...
import "./storages/CarbonProjectVintagesStorage.sol";
	...
	ProjectUtils
{
	...
	function initialize() external virtual initializer {
		...
		__ERC721_init_unchained(
			"Kyklos Protocol: Carbon Project Vintages",
			"KYKLOS-CPV"
		);
	...
	function getProjectVintageDataByTokenId(
		uint256 tokenId
	) external view virtual override returns (VintageData memory) {
